...
df_websites = pd.read_csv('Websites_Data/websites.csv')#read in the website csv
...
df_type.to_csv(r'Websites_Data/wtype_clean.csv', header=True)
print('')


df_type_fake = df_type[df_type['type'] == 'fake']# this will print only data with first type = fake
print(df_type_fake.head())
df_type_fake.to_csv(r'Websites_Data/wtype_only_fake_news.csv', header=True)
print('')
# this prints everything but fake news in first type
df_type_notfake = df_type[df_type['type'] != 'fake']
df_type_notfake.to_csv(r'Websites_Data/wnot_fake_news.csv', header=True)
...
df_2nd_type_fake.to_csv(r'Websites_Data/w2nd_type_isfake_news.csv', header=True)

print('')
# this prints everything but fake news in second type
df_2nd_type_notfake = df_2nd_type[df_2nd_type['2nd_type'] != 'fake']
df_2nd_type_notfake.to_csv(r'Websites_Data/w2nd_type_not_fake_news.csv', header=True)
...
df_3rd_type_fake.to_csv(r'Websites_Data/w3rd_type_is_fake_news.csv', header=True)
print('')
# this prints everything but fake news in second type
df_3rd_type_notfake = df_3rd_type[df_3rd_type['3rd_type'] != 'fake']
df_3rd_type_notfake.to_csv(r'Websites_Data/w3rd_type_not_fake_news.csv', header=True)
